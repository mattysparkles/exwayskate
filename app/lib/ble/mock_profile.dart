...
class MockProfile implements BoardProfile {
  ...
  @override
  Guid? get lightingServiceId => Guid('00000000-0000-0000-0000-00000000B0B0');

  @override
  Guid? get lightingChar => Guid('00000000-0000-0000-0000-00000000B001');

  @override
  Guid? get securityServiceId => Guid('00000000-0000-0000-0000-00000000C0C0');

  @override
  Guid? get securityChar => Guid('00000000-0000-0000-0000-00000000C001');

  // >>> Added: satisfy BoardProfile getters <<<
  @override
