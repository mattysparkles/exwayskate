...
class Rides extends Table {
  ...
  TextColumn get cloudStatus => text().withDefault(const Constant('pending'))();
...
class PackMetrics extends Table {
  IntColumn get id => integer().autoIncrement()();
  DateTimeColumn get ts => dateTime()();
  RealColumn get soh => real()();        // 0..1 or %
  RealColumn get sagIndex => real()();   // 0..1
}
...
class EscMetrics extends Table {
  ...
  RealColumn get etaMin => real()();     // minutes to throttle
}
